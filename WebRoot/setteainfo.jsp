				...
				<div class="graphs">
					<div class="sign-up">
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								<form>
									<input type="text" value="<s:property value="#session.user.tname"/>"/>
								</form>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="sign-u">
							...
							<div class="sign-up2">
								<form>
									<input type="text" value="<s:property value="#session.user.trank"/>"/>
								</form>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="sub_home">
							...
							<div class="sub_home_right">
								<p>返回<a href="teacher/start.action">主页</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
