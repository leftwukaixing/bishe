			...
			<div id="page-wrapper" class="sign-in-wrapper">
				<div class="graphs">
					<div class="sign-up">
						...
						<form action="<%=basePath %>addTeacher!addTeacher" method="post">
						<h5>个人信息</h5>
						<div class="sign-u">
							<div class="sign-up1">
								<h4>工号* :</h4>
							...
							<div class="sign-up2">
								<input type="text" placeholder="教师工号" name="tea.tno"/>
							</div>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								<input type="text" placeholder="教师姓名" name="tea.tname"/>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="sign-u">
							...
							<div class="sign-up2">
								<input type="text" placeholder="教师职位" name="tea.trank"/>
							</div>
							<div class="clearfix"> </div>
						</div>
						<h6>登录信息</h6>
